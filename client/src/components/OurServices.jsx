...
function OurServices() {
  ...
  return (
    <section className="container py-5 my-sm-2 my-md-4 my-lg-5">
      <h2
        className="h1 text-center pt-sm-3 mt-xxl-3 mx-auto mb-4"
      ...
      <div className="row row-cols-1 row-cols-sm-2 row-cols-lg-3 gy-3 gy-sm-4 gy-xl-5 gx-4 gx-md-5 pb-xxl-4 mb-sm-2 mb-lg-0 mb-xl-2">
        <div className="col">
          <div className="text-center px-xxl-4">
            ...
            <h3 className="h4 mb-2">{t("getYourTraffic")}</h3>
            <p>
            {t("descGetYourTraffic")}.
            </p>
          </div>
        </div>
        ...
        <div className="col">
          <div className="text-center px-xxl-4">
            ...
            <h3 className="h4 mb-2">{t("easySearch")}</h3>
            <p>{t("descEasySearch")}.</p>
          </div>
        </div>
        <div className="col">
        <div className="text-center px-xxl-4">
          ...
          <h3 className="h4 mb-2">{t("payTheFineByReceipt")}</h3>
          <p>
          {t("descPayFine")}.
          </p>
        </div>
        ...
        <div className="col">
          <div className="text-center px-xxl-4">
            ...
            <h3 className="h4 mb-2">{t("paymentFastAndSecure")}</h3>
            <p>{t("descPaymentFastAndSecure")}.</p>
          </div>
        </div>
        <div className="col">
          <div className="text-center px-xxl-4">
            ...
            <h3 className="h4 mb-2">{t("notifications")}</h3>
            <p>
            {t("descNotifications")}.
            </p>
          </div>
        ...
        <div className="col">
          <div className="text-center px-xxl-4">
            ...
            <h3 className="h4 mb-2">{t("dataSecurity")}</h3>
            <p>
            {t("descDataSecurity")}.
            </p>
          </div>
