...
function OrderDetailsByReceipt({ userData }) {
  ...
  const assignDriver = async (e) => {
    ...
    await axios.put(
      `${BASE_URL}/api/order-pay-receipt/${id}`,
      {
        ...
        notification: `لديك طلب جديد رقم #${order.orderId}`,
      },
      {
        headers: {
          Authorization: `Bearer ${localStorage.getItem("token")}`,
          ...
          <div className="mt-1 col-lg-8 bg-light container p-5 text-dark">
            ...
            <div className="d-flex justify-content-between align-items-center">
              <Link
                role="button"
                className="text-info"
                to={`/order-by-receipt/invoice/${order._id}`}
              >
                <i className="fas fa-print"></i> {t("invoicePrint")}
              </Link>
              <span>
                {t("receiptNumber")}: {order.receiptNumber}
              </span>
              <button
                type="button"
            ...
            <div className="row mt-5">
              ...
              {order?.driver !== null && (
                <div className="col-sm-6">
                  <div className="card">
                    <div className="card-body">
                      <h5 className="card-title">{t("delegateInfo")}</h5>
                      <div className="d-flex meta-link fs-sm align-items-center pt-3">
                        <img
                          className="rounded-circle"
                          src={
              ...
              <div>
                <div className="card mb-5">
                  <h4 className="py-3 text-center">{t("fineReceipt")}</h4>
                  <img
                ...
                <div className="card">
                  <h4 className="py-3 text-center">{t("annual")}</h4>
                  <img
        ...
        <div className="modal-dialog" role="document">
          <div className="modal-content">
            <div className="modal-header">
              <h5 className="modal-title">{t("assignDelegate")}</h5>
            </div>
...
export default OrderDetailsByReceipt;
